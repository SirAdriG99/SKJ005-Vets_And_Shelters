        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id" :paginator="true"
                    ...
                    <Column field="inventoryStatus" header="Sexo" :sortable="true"
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Animals" :modal="true"
                    class="p-fluid">
                    <img :src="'demo/images/product/' + product.image" :alt="product.image" v-if="product.image" width="150"
                        class="mt-0 mx-auto mb-5 block shadow-2" />
                    <div class="field">
                        <label for="DNI">DNI</label>
                        <InputText id="DNI" v-model.trim="product.name" required="true" autofocus
                    ...
                    <div class="field">
                        ...
                        <InputText id="color" v-model.trim="product.name" required="true" autofocus
                            :class="{ 'p-invalid': submitted && !product.name }" />
